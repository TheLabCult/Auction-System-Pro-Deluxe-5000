...
/**
 * Business logic for manual bids, auto-bids, bid history, and per-auction locking.
 */
public final class BidManager {
    ...
    public BidManager(AuctionDAO auctionDAO, BidDAO bidDAO,
                      AutoBidDAO autoBidDAO, AuctionManager auctionManager) {
    ...
    public BidTransaction placeBid(long auctionId, double amount, User bidder) {
        ...
        try {
            ...
            auctionManager.markRunning(auction);  // OPEN -> RUNNING on first bid
            ...
            auctionManager.applyAntiSnipe(auction);
